...
def search_inscriptions(db: Session, query: str, fields: List[str] = None, skip: int = 0, limit: int = 100):
    ...
    for field in fields:
        if field in FIELD_MAP:
            ...
            field_matches = [FIELD_MAP[field].like(pattern) for pattern in search_patterns]
    ...
    if not conditions:
        ...
        core_fields = [models.Inscription.name, models.Inscription.transcript, models.Inscription.discovery]
